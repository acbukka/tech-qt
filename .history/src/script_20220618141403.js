...
card.forEach((item) => item.addEventListener('click', (e) => {
  ...
  if (element.classList.contains('selected')) {
    ...
    switch (whatElement) {
      case 0:
        cardInfo.textContent = 'Печень утки разварная с артишоками.'
        break
      case 1: 
        cardInfo.textContent = 'Головы щучьи с чесноком да свежайшая сёмгушка.'
        break
      case 2:
        cardInfo.textContent = 'Филе из цыплят с трюфелями в бульоне.'
        break
    }
